...
The following figue shows the record Penopto footage in a classroom. The white rectanges are the grouped zones for easier detection and manual zone mapping. While the green rectangles are detected humans. Note that the graphic only show the detected human in the specified zones.
