...
The figure above shows the basic web application. The web application shows the real-time zone occupancy on the record footage.

<img width="1132" height="640" alt="image" src="https://github.com/user-attachments/assets/01c03aa2-a8c1-4aee-bb49-7f4930756c40" />
The figue above shows the record Penopto footage in a classroom. The white rectanges are the manually drawed zones for easier detection, while the green rectangles are detected humans. Note that the graphic only shows the detected humans that fall within the specified zones.
